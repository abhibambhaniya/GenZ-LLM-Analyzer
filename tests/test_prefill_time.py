import pytest
from GenZ import prefill_moddeling, get_model_df, get_configs, System, create_inference_moe_prefix_model, get_AR_time
import os
import pandas as pd
...
def test_dense_LLM_prefill():
    ...
    current_df = get_model_df(model=create_inference_moe_prefix_model(4096, Model), system=TPU)
